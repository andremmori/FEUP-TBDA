...
DROP TABLE "ACTIVITY_FACILITIES" CASCADE CONSTRAINTS;
DROP TABLE "DISTRICT_MUNICIPALITIES" CASCADE CONSTRAINTS;
DROP TABLE "FACILITY_ACTIVITIES" CASCADE CONSTRAINTS;
DROP TABLE "MUNICIPALITY_FACILITIES" CASCADE CONSTRAINTS;
DROP TABLE "REGION_DISTRICTS" CASCADE CONSTRAINTS;
DROP TABLE "REGION_MUNICIPALITIES" CASCADE CONSTRAINTS;
